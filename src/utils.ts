...
function clearBleed(index: number, string: string, open: string, close: string, replace: string) {
  return index < 0
    ? open + string + close
    : open + replaceClose(index, string, close, replace) + close;
}

function filterEmpty(open: string, close: string, replace = open, at = open.length + 1) {
